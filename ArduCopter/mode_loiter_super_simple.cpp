...
/*
 * Init and run calls for loiter super simple flight mode
 */
...
#if AC_PRECLAND_ENABLED
bool ModeLoiterSuperSimple::do_precision_loiter()
{
...
void ModeLoiterSuperSimple::precision_loiter_xy()
{
    loiter_nav->clear_pilot_desired_acceleration();
...
void ModeLoiterSuperSimple::run()
{
    float target_roll, target_pitch;
...
uint32_t ModeLoiterSuperSimple::wp_distance() const
{
    return loiter_nav->get_distance_to_target();
}

int32_t ModeLoiterSuperSimple::wp_bearing() const
{
